...
public class Md5Util {
    ...
    public static String md5DigestAsHex(String content) {
        return digestAsHexString(MD5_ALGORITHM_NAME, content.getBytes(StandardCharsets.UTF_8));
    }

    public static String md5DigestAsHex16(String content) {
        String hex = md5DigestAsHex(content);
